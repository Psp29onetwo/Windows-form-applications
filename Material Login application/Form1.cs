...
namespace Material_Login_application
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            materialLabel2.Parent = pictureBox1;
            materialLabel2.BackColor = Color.Transparent;
            materialLabel2.ForeColor = Color.FromArgb(230,230,230);
            materialLabel2.Font = new Font(FontFamily.GenericSansSerif, 13.0F, FontStyle.Bold);
            ...
            materialFlatButton3.BackColor = Color.Red;
        }
